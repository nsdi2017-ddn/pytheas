...
LOCAL_DDN="/Users/junchenjiang/Documents/research/ddn-controller/proto/shijie/DDN"
...
scp $PRE -r $LOCAL_DDN/$TRACE $SSH:$REMOTE_USER_
...
ssh $PRE $SSH -t 'cd '$REMOTE_USER_ROOT/$TRACE/'; ./trace_parser.py http://'$FrontendIp'/player_EG.php '$TraceSorted
